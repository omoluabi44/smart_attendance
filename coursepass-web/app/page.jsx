  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <Link href="/signup" className="bg-blue-500 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-600 transition shadow-lg shadow-blue-200">
         Sign Up
        </Link>
          <Link href="/login" className="bg-white text-blue-500 px-6 py-2 rounded-full font-semibold hover:bg-blue-600 transition shadow-lg shadow-blue-200">
          Login
        </Link>
      </nav>
